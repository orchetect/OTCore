...
extension String {
    /// **OTCore:**
    /// Sanitizes illegal characters in a path component based on the specified file system.
    ...
    ///
    /// - Parameters:
    ///   - formats: Target file system(s). Passing `nil` sanitizes the string for all supported file systems.
    ...
    private mutating func _sanitizePathComponent(
        ...
        case .hfsPlus, .apfs:
            ...
            // Even though HFS+ and APFS file systems both support all Unicode characters, most APIs provided
    ...
    /// file system. This method takes an over-cautious approach by replacing certain characters
