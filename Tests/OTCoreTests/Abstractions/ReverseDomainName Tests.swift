...
@Suite struct ReverseDomainNameTests {
    ...
    @Test func initString_OneTLDComponent_TwoPrefixes() throws {
        ...
        #expect(ReverseDomainName("com.apple.www.zzz").domainAndExtensionComponents == ["com", "apple"])
    ...
    @Test func initString_TwoTLDComponents_NoPrefix() throws {
        ...
        #expect(ReverseDomainName("uk.co.apple").domainAndExtensionComponents == ["uk", "co", "apple"])
    ...
    @Test func initString_TwoTLDComponents_OnePrefix() throws {
        ...
        #expect(ReverseDomainName("uk.co.apple.www").domainAndExtensionComponents == ["uk", "co", "apple"])
    ...
    @Test func initString_TwoTLDComponents_TwoPrefixes() throws {
        #expect(ReverseDomainName("uk.co.apple.www.zzz").components == ["uk", "co", "apple", "www", "zzz"])
        ...
        #expect(ReverseDomainName("uk.co.apple.www.zzz").domainAndExtensionComponents == ["uk", "co", "apple"])
